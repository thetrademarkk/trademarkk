...
export function AdherencePanel({ from, to }: { from: string | null; to: string | null }) {
  ...
  // The costliest-habit nudge now lives at the top of the AdherenceRingCard
  // (shown above this panel on the Rules page), so it's not repeated here — each
  // rule row below still carries its own broken-day cost.
  return (
    <Card>
