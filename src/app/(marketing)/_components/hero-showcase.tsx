...
export function HeroShowcase() {
  ...
  return (
    // The entrance is CSS (.animate-rise on the inner div) instead of a motion
    // animation: motion serializes opacity:0 into the SSR HTML, so the whole
    // showcase stayed invisible until hydration — a mobile-LCP killer. The
    // float keyframe stays on the outer div (one transform animation each).
    <div className="relative mx-auto mt-14 w-full max-w-3xl animate-float-slow">
      <div className="animate-rise" style={{ "--rise-delay": "250ms" } as React.CSSProperties}>
