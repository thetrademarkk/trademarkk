 ...
 * Restored from landing v1 by user request; the only deltas from the original
 * are the scene order (the signature ₹18,920 / 67% / 2.1R frame paints first)
 * and a test id for the e2e suites.
 */
const SCENES = [
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="relative overflow-hidden rounded-xl border bg-surface text-left shadow-2xl"
      >
        {/* window chrome */}
