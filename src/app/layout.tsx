...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: siteConfig.url,
    locale: "en_IN",
    // Explicit so pages that set their own `openGraph` (e.g. a per-route
    // canonical url) still inherit the branded card image. Same-origin path —
    // safe under the `img-src` CSP. The route handler emits a 1200×630 PNG.
    images: [
      {
        url: "/opengraph-image",
        width: 1200,
