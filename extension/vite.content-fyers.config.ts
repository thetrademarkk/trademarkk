...
/**
 * Seventh build pass: the Fyers order-window capture content script. Chrome
...
export default defineConfig({
  ...
  build: {
    ...
    emptyOutDir: false,
    rollupOptions: {
      input: path.resolve(dir, "src/content/fyers-capture.ts"),
      output: { format: "iife", entryFileNames: "content-fyers.js" },
    },
  },
});
